 ...
 * @since 1.6
 **/
public class CharStringWriter extends AbstractWriter<String> {

	@Override
	public String write(char[][] buffers, int length, int bufferIndex, int writeIndex) throws WriteFailedException {
		try {
			int index = 0;
