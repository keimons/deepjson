...
public class SourceCodeJavaFileManager extends ForwardingJavaFileManager<JavaFileManager> {
	...
	private final SourceCodeClassLoader classLoader;
	private final Map<URI, JavaFileObject> javaFileObjectMap = new ConcurrentHashMap<>();

	public SourceCodeJavaFileManager(JavaFileManager fileManager, SourceCodeClassLoader classLoader) {
		super(fileManager);
	...
	public JavaFileObject getJavaFileForOutput(Location location, String className, JavaFileObject.Kind kind, FileObject sibling) throws IOException {
		JavaFileObject javaFileObject = new SourceCodeJavaFileObject(className, kind);
